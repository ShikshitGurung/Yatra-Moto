...
import { getOrdersForUser, deleteOrder } from '../../order';
import { getAddressesForUser, addAddress, deleteAddress } from '../../address';
...
function ProfileSettings({ user, onProfileUpdate }) {
  ...
  const handleSubmit = (e) => {
    ...
    startTransition(() => {
        const updates = {};
        if (formData.fullName && formData.fullName !== user.name) updates.name = formData.fullName;
  ...
  return (
    <div className='text-black'>
      <h2 className="text-3xl font-bold mb-6 text-black border-b pb-4">Profile Settings</h2>
      <form onSubmit={handleSubmit} className="space-y-6 max-w-lg">
        ...
        <div>
          <label className="block text-sm font-medium text-black">Mobile Number (Optional)</label>
...
function OrderHistory({ user }) {
  ...
  return (
    <div className='text-black'>
      <h2 className="text-3xl font-bold mb-6 text-black border-b pb-4">Order History</h2>
      {orders.length > 0 ? (
